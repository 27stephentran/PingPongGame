...
pause_text = font_1.render("PAUSED", 1, (200, 255, 100))

starting_text = font_1.render("Choose set points", 1, (100, 255, 100))
ending_text = font_1.render("Game Over", 1, (0,255,100))
...
while not game_over:
    ...
    if not finish:
        if choosen_point == 0:
            text_y = 250
            window.blit(starting_text, (80, 200))
        ...
        if game_status == None and choosen_point != 0:
            ...
            window.fill(background_color)
            point_text_l = font_2.render(f"points: {point_l}", 1, (255, 0, 255))
            point_text_r = font_2.render(f"points: {point_r}", 1, (255, 0, 255))
            ...
            window.fill(background_color)
            window.blit(pause_text, (180,200))
            
        elif game_status == "ended":
            window.fill(background_color)
            window.blit(ending_text, (180,200))
            if point_r > point_l:
                winner = font_2.render("Player 2 win the game", 1, (0, 255, 0))
            else:
                winner = font_2.render("Player 1 win the game", 1, (0, 255, 0))
            window.blit(winner, (180,260))
